...
export default function PedicureClient() {
  const { t } = useTranslation("pedicure")

  const services = t("cards", { returnObjects: true }) as {
    title: string
    description: string
    duration: string
    price: string
  ...
  return (
    <>
      ...
      {/* CTA */}
      <section
        className="bg-pink text-white text-center py-5 mt-5"
        style={{ maxWidth: 1000, height: 250, margin: "0 auto" }}
      >
        <div className="container">
